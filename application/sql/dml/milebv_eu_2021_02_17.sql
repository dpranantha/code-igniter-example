...
-- Generation Time: Feb 17, 2021 at 12:35 PM
...
(94, 'TC-25', 'Vegan chili chicken', NULL, '素 韓 式 雞 丁', 250, 40, NULL, NULL, NULL, 'This product contains soy and wheat.'),
(95, 'TC-38', 'Vegan meat burger', NULL, '全 素 肉 排', 250, 24, NULL, NULL, NULL, 'This product contains soy and wheat.'),
(96, 'AZ-07', 'Vegan squid shreds', NULL, '素 魷 魚 絲', 100, 50, NULL, NULL, NULL, 'This product contains soy and wheat.'),
...
(102, 'AJ-08', 'Vegan fish tofu', NULL, '素 麥 香 條', 300, 40, NULL, NULL, NULL, 'This product contains soy.'),
...
(105, 'D-128', 'Vegan almond seaweed', NULL, '海 苔 杏 仁 片', 40, 20, NULL, NULL, NULL, 'This product contains sesame.'),
(106, 'DX-06', 'Vegan vegetable bun', NULL, '高 麗 菜 包 子', 12, 12, NULL, NULL, NULL, 'This product contains soy, wheat, and sesame.'),
(107, 'DX-08', 'Vegan taro bun', NULL, '芋 泥 包 子', 12, 12, NULL, NULL, NULL, 'This product contains milk, wheat, and sesame.'),
...
(111, 'JW-01', 'Vegan mushroom oyster sauce (Small)', NULL, '萬 家 香 香 菇 素 蠔 油 (Small)', 300, 12, NULL, NULL, NULL, 'This product contains soy and wheat.'),
(112, 'JW-04', 'Vegan mushroom oyster sauce (Large)', NULL, '萬 家 香 香 菇 素 蠔 油 (Large)', 1000, 12, NULL, NULL, NULL, 'This product contains soy and wheat.'),
(114, 'CK-01', 'Vegan ham (Large)', NULL, '萬 家 香 火 腿 (大)', 1000, 10, NULL, NULL, NULL, 'This product contains soy and wheat'),
(115, 'TC-34', 'Vegan lemon chicken', NULL, '素檸檬雞', 250, 40, NULL, NULL, NULL, 'This product contains soy and wheat'),
(116, 'SW-03', 'Vegan mouth breeder', NULL, '吳 郭 魚', 300, 40, NULL, NULL, NULL, 'This product contains soy'),
(117, 'CW-01', 'Vegan Mexico hotdog', NULL, '全 素 墨 西 哥 大 熱 狗', 500, 30, NULL, NULL, NULL, 'This product contains soy'),
(118, 'AJ-11', 'Vegan vegetable balls', NULL, '全 素 福 壽 丸', 300, 30, NULL, NULL, NULL, 'This product contains soy and wheat.'),
(119, 'AJ-12', 'Vegan fish balls', NULL, '全 素 淡 水 魚 丸', 300, 40, NULL, NULL, NULL, 'This product contains soy and wheat.'),
