...
-- Generation Time: Feb 13, 2021 at 09:57 PM
...
(3, 'AJ-03', 'Vegan Stuffing Balls', 'Vegan Bällchen mit Füllung', '芙蓉丸', 300, 40, 'Boil water, add desired amount, add vegetables, cook and serve. Ideal for soups.', NULL, NULL, 'This product contains soy and wheat.'),
...
(5, 'CH-01', 'Vegan Bean Curd', 'Vegan Tofu', '百頁豆腐', 595, 30, 'Defrost, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy.'),
...
(7, 'CH-03', 'Vegan Stewed Meat', 'Vegan Geschmortes Fleisch', '全素燉肉', 300, 50, 'Defrost, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy and wheat.'),
(8, 'CH-04', 'Vegan Chicken Chunk', 'Vegan Chicken Nuggets', '全素雞塊', 300, 30, 'Deep fry and serve.', NULL, NULL, 'This product contains soy.'),
(9, 'CH-05', 'Vegan No. 1 Ham', 'Vegan Nr. 1 Schinken', '金牌火腿', 1000, 12, 'Defrost, cut into desired slices or chunks, pan fry with oil mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy and wheat.'),
(10, 'CH-06', 'Vegan No. 1 Ham', 'Vegan Nr. 1 Schinken', '金牌火腿(小)', 500, 24, 'Defrost, cut into desired slices or chunks, pan fry with oil mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy and wheat.'),
(11, 'CK-06', 'Vegan Nice Ham', 'Vegan Nice Schinken', '萬家香素火腿', 500, 20, NULL, NULL, NULL, 'This product contains soy.'),
...
(13, 'CK-05', 'Vegan Maik Chicken Nugget', 'Vegan Hähnchen Nugget', '麥克雞塊', 200, 25, 'Deep fry and serve.', NULL, NULL, 'This product contains soy, wheat and sesame.'),
...
(15, 'CW-03', 'Vegan Ham Slices', 'Vegan Schinkenstreifen', '麵包火腿片', 250, 40, 'Defrost, pan fry with oil and serve with bread.', NULL, NULL, 'This product contains soy and wheat.'),
...
(18, 'CW-09', 'Vegan Crispy Squid Ring', 'Vegan Crispy Calamariringe', '香酥花枝圈', 250, 40, 'Deep fry and serve.', NULL, NULL, 'This product contains soy, wheat  and celery.'),
(19, 'CW-11', 'Vegan Smoked-Flavor Ham', 'Vegan Geraeucherter Kochschinken', '燻味火腿', 500, 36, 'Defrost, cut into desired slices or chunks, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy and wheat.'),
...
(22, 'ED-06', 'Vegan Chicken', 'Vegan Hähnchen', '素油水雞', 300, 40, 'Defrost, cut into desired slices or chunks, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, NULL),
(23, 'FC-01', 'Vegan Fresh Bean Curd Peel', 'Vegan Frische Tofublättertetig', '豆包', 1000, 20, '1. Defrost, cut into desired slices, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.  Or 2. Defrost, cut into desired slices, pan fry with oil, serve with noodle soup.', NULL, NULL, 'This product contains soy.'),
(24, 'FC-06', 'Vegan Fresch Bean Curd Roll', 'Vegan Frische Tofutteigrollen', '豆卷', 1000, 16, 'Defrost, cut into desired chunks, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve. ', NULL, NULL, 'This product contains soy.'),
...
(27, 'HS-04M', 'Veggie Bacon Sausage', 'Veggie Speckwurst', '臘肉香腸', 300, 40, NULL, NULL, NULL, 'This product contains soy, wheat and milk.'),
(28, 'HS-10M', 'Veggie Konjac Sausage', 'Veggie Konjawurst', '蒟蒻香腸', 300, 40, NULL, NULL, NULL, 'This product contains soy, wheat and milk.'),
(29, 'HS-11M', 'Veggie Yi-Pin Balls', 'Veggie  Yi-Pin Bällchen', '一品丸', 300, 30, NULL, NULL, NULL, 'This product contains soy and milk.'),
...
(31, 'HS-18M', 'Veggie Tea-Flavor Goose', 'Veggie Gans mit Teegeschmack', '素茶鵝', 300, 40, NULL, NULL, NULL, 'This product contains soy and milk.'),
(32, 'HY-04', 'Vegan Shrimp', 'Vegan Garnelen', '素草蝦', 300, 40, 'Defrost, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, ''),
...
(35, 'KC-10M', 'Vegan Salt-roasted Chicken', 'Vegan Salz-geröstetes Hähnchen', ' 鹽酥雞', 300, 30, NULL, NULL, NULL, 'This product contains soy, wheat and milk.'),
(36, 'KC-21', 'Vegan/ Veggie Pepper Steak', 'Vegan/ Veggie Pfefferschnitzel', '黑胡椒大排', 300, 40, 'Defrost, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy.'),
(37, 'KC-22M', 'Veggie Lion-Head Meatballs', 'Veggie Lowenkopf-Fleischklösschen', '獅子頭', 300, 30, NULL, NULL, NULL, 'This product contains soy, wheat and milk.'),
(38, 'KC-23', 'Vegan/ Veggie Chicken Pieces', 'Vegan/ Veggie Hühnerstücken', '素雞丁', 300, 40, 'Defrost, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy and wheat.'),
...
(42, 'SS-06', 'Vegan Clay Pot Stewed Mutton', 'Vegan Tontopf Hammelfleisch', '素燉羊肉', 600, 20, 'Defrost, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy.'),
(43, 'SW-01', 'Vegan Small Sausages', 'Vegan Mini-Würstchen', '小香腸', 200, 40, 'Defrost, pan fry with oil, mix with vegetables, add desired sauce(s), cook and serve.', NULL, NULL, 'This product contains soy.'),
...
(55, 'TC-20', 'Vegan Beef Meatballls', 'Vegan Rindfleisch Fleischbällchen', '新牛肉丸', 250, 40, 'Boil water, add desired amount, add vegetables, cook and serve. Ideal for soups.', NULL, NULL, 'This product contains soy.'),
...
(65, 'WL-02M', 'Veggie Fresh Bean Curd', 'Veggie Frischen Tofu', '百頁條', 300, 30, NULL, NULL, NULL, 'This product contains soy and milk.'),
...
(68, 'WL-09M', 'Veggie Fish Air Bladder', 'Veggie Fisch-Luftblase', '烏魚鰾', 300, 30, NULL, NULL, NULL, 'This product contains soy and milk.'),
...
(73, 'YH-04M', 'Vegan Chicken Steak', 'Vegan Hühnersteak', '香吉排', 300, 40, NULL, NULL, NULL, 'This product contains soy, wheat and milk.'),
...
(75, 'YH-09', 'Vegan Ru-Yi Sandwich Ham', 'Vegan Ru-Yi Schinken Aufschnitte', '如意火煺片', 1000, 17, 'Defrost, pan fry with oil and serve with bread.', NULL, NULL, 'This product contains soy.'),
...
(89, 'SB01', 'Vegan Salmon Sashimi', 'Veganer Lachs Sashimi', '三文魚生魚片', 230, 70, 'Defrost and serve, ideal for sushi or serve with wasabi dip', NULL, NULL, NULL),
(90, 'SB02', 'Vegan Tuna Sashimi', 'Veganes Thunfisch Sashimi', '金槍魚生魚片', 230, 70, 'Defrost and serve, ideal for sushi or serve with wasabi dip', NULL, NULL, NULL),
(91, 'TC05', 'Vegan black pepper strips', NULL, '黑 胡 椒 肉 條', 250, 40, NULL, NULL, NULL, 'This product contains soy and wheat.'),
(92, 'TC09', 'Vegan over eggs', NULL, '全 素 荷 包 蛋', 200, 40, NULL, NULL, NULL, 'This product contains soy.'),
(93, 'TC15', 'Vegan spare ribs', NULL, '素 蓮 藕 排 骨', 250, 40, NULL, NULL, NULL, 'This product contains soy and wheat.'),
...
(101, 'AJ06', 'Vegan fish Crisp', NULL, '素 魚 酥 ', 300, 30, NULL, NULL, NULL, 'This product contains soy and wheat.'),
...
(113, 'JW08', 'Vegan natural soy sauce', NULL, '黑 豆 醬 油', 450, 12, NULL, NULL, NULL, 'This product contains soy and wheat.');
...
(3, 3, 'assets/img/products/AJ03.jpg'),
(4, 4, 'assets/img/products/AJ07.jpg'),
(5, 5, 'assets/img/products/CH01.jpg'),
(6, 6, 'assets/img/products/CH02.jpg'),
(7, 7, 'assets/img/products/CH03.jpg'),
(8, 8, 'assets/img/products/CH04.jpg'),
(9, 9, 'assets/img/products/JC35.jpg'),
(10, 10, 'assets/img/products/JC35.jpg'),
...
(22, 22, 'assets/img/products/ED06.jpg'),
...
(37, 37, 'assets/img/products/KC22M.jpg'),
...
(43, 43, 'assets/img/products/SW01.jpg'),
...
(65, 65, 'assets/img/products/WL02M.jpg'),
(66, 66, 'assets/img/products/WL03M.jpg'),
(67, 67, 'assets/img/products/WL08M.jpg'),
(68, 68, 'assets/img/products/WL09M.jpg'),
...
(89, 89, 'assets/img/products/SB01.jpg'),
(90, 90, 'assets/img/products/SB01.jpg'),
...
(113, 113, 'assets/img/products/JW08.jpg');
