...
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='AJ11'),'assets/img/products/AJ11.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='AJ12'),'assets/img/products/AJ12.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='D035'),'assets/img/products/D035.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='D088'),'assets/img/products/D088.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='D099'),'assets/img/products/D099.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='D106'),'assets/img/products/D106.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='D123'),'assets/img/products/D123.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='D129'),'assets/img/products/D129.jpg');
-- INSERT INTO product_assets(p_id, url) values ((select id from product where product_code='D130'),'assets/img/products/D130.jpg');
